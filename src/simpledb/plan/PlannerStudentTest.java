...
public class PlannerStudentTest {
    public static void main(String[] args) {
        ...
        // part 3: Process an ORDER BY query
        qry = "select sname, gradyear, majorid from student order by majorid";
        ...
        qry = "select sname, gradyear, majorid from student order by gradyear desc";
        p = planner.createQueryPlan(qry, tx);
        s = p.open();
        while (s.next())
            System.out.println(s.getString("sname") + " " +
